...
workspace "libRaven"
	...
	filter "configurations:Debug"
		...
		defines { "WIN32", "_DEBUG", "_WINDOWS", "_USRDLL", "LIBRAVEN_EXPORT", "LIBRAVEN_DYNAMIC", "IG_GFX_DX9", "IG_TARGET_WIN32", "IG_TARGET_TYPE_WIN32", "IG_ALCHEMY_DLL", "IG_DEBUG" }
		symbols "On"
	...
	links { "libIGCore", "libIGAttrs", "libIGGfx" }
